  ...
  return (
    <div className="flex flex-col gap-0 w-[100vw] border-2 border-red-800">
      ...
      <div className="  relative  ">
        ...
        <div className="relative flex flex-col justify-between items-center lg:grid grid-cols-3 lg:place-items-start  h-[142vh] lg:h-[40vh] w-[99vw]  mt-[73rem] lg:mt-[5rem] px-3 ">
          ...
          <div className="flex flex-col justify-between items-center mr-[2rem] lg:col-span-1 lg:ml-[4rem]">
            <div className="flex flex-col justify-center items-center lg:flex lg:items-start gap-3">
          ...
          <div className="flex flex-col justify-between items-center lg:col-span-1 lg:ml-[4rem]">
            <div className="flex flex-col justify-center items-center mr-[2rem] lg:flex lg:items-start gap-3">
        ...
        <div className="h-[119vh]  bg-red-50 flex flex-col items-center mt-[1rem] ">
          <div className="text-black text-[1rem] lg:text-[1.5rem] mt-[6rem] underline underline-offset-[1.05rem] lg:underline-offset-[1.75rem] decoration-[0.1rem] lg:decoration-[0.15rem] px-4">
            Testimonials
          </div>
          ...
          <div className="text-black text-[0.95rem] mt-[2rem] flex flex-col">
            <span className=" px-[4rem] lg:mx-[10rem] ">
              Aliquip quae scipit eros. Anim commodi maiores pharetra, arcu
              incidunt, omnis iste
            </span>{" "}
            <span className="px-[4rem] lg:px-[11rem] ">
        ...
        <div className="text-black text-[0.95rem]  grid grid-cols-2 lg:grid-cols-6 place-items-center gap-7 lg:gap-5  mt-[5rem] px-8">
          <img
        ...
        <div className="">
        <div className="text-black text-[0.95rem]  lg:grid lg:grid-cols-3 place-items-center gap-5 mt-3 lg:mt-[5rem] px-5 lg:px-8 h-[98vh] ">
         ...
         <div className="h-[165vh] relative parallax-container flex flex-col  place-items-start mt-[67rem] lg:mt-[20rem] gap-">
         <div className="text-white/85 text-[1rem] lg:text-[1.5rem] underline underline-offset-[1.75rem] decoration-[0.15rem] px-4 mt-[0.25rem] lg:top-2">
            Contact Me
          </div>
          <div className="text-white/85 text-[1.7rem] lg:text-[3rem] px-4 ">
